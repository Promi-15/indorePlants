...
const Card = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 my-28  lg:max-w-7xl lg:mx-auto justify-center">
      <div className="border-2 text-green-900 w-72 p-10 rounded-2xl hover:bg-slate-50 hover:transform hover:transition hover:duration-1000 hover:scale-105 mx-auto">
